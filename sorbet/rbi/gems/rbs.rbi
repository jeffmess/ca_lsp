...
class RBS::EnvironmentLoader::Library < Anonymous_Struct_6
end
...
class RBS::DefinitionBuilder::MethodBuilder::Methods::Definition < Anonymous_Struct_7
end
...
class RBS::Prototype::RB::Context < Anonymous_Struct_8
end
